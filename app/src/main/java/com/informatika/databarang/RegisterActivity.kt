...
import kotlinx.android.synthetic.main.activity_register.btn_clean
...
class RegisterActivity : AppCompatActivity() {
    ...
    fun actionData(username : String, password : String){
        koneksi.service.register(username,password).enqueue(object : Callback<ResponseUsers>{
            ...
            if(response.isSuccessful){
                ...
                if(resStatus == true){
                    ...
                    Toast.makeText(this@RegisterActivity, "Username atau Password Anda Salah!", Toast.LENGTH_LONG).show()
                }
            }
        }
